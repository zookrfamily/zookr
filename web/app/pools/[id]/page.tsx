      ...
      <main className="wrap page">
        ...
        {!d ? <div className="empty">Loading…</div> : !p ? <div className="empty">No such pool.</div> : (
          <>
            ...
            <div className="g31">
              <div>
                <h2 style={{ fontSize: 20, margin: "0 0 12px", color: "#fff" }}>Top eligible holders</h2>
